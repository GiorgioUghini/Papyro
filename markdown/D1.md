...
* Author: extends authors with the informations about its books  
* BaseBook: basic data about a book, without any information on its relations. used when the book is an attribute of the requested element  
...
### Analysis of existing API **Describe here if you have found relevant APIs that have inspired the OpenAPI specification and why (at least two).**  
